...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="34ed8860-53e4-46db-b8b6-31bfe1fa94cf"
                type="wpfhost"
                hostedType="Addons\QRCodeGenerator\QRCodeGenerator.dll,QRCodeGenerator.ShowWindowBtn"
                enable="true"/>
    ...
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="34ed8860-53e4-46db-b8b6-31bfe1fa94cf"/>
        </container>
